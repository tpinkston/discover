...
public class VDIS {
    ...
    public static final int
        ...
        CRYPTO_SYS = 18,
        CUSTOM_AIR_SMOKE = 19,
        CUSTOM_ARTICULATED_PARTS_METRIC = 20,
        CUSTOM_ENT_CNTRY = 21,
        CUSTOM_ENT_DOMAIN = 22,
        CUSTOM_ENT_KIND = 23,
        CUSTOM_FROZEN_BEHAVIOR = 24,
        CUSTOM_IED_PRESENCE = 25,
        CUSTOM_LAND_SMOKE = 26,
        CUSTOM_LF_EQ_LASER = 27,
        CUSTOM_OBJ_DAMAGE = 28,
        CUSTOM_ONOFF = 29,
        CUSTOM_SEVERITY = 30,
        CUSTOM_SLING_DAMAGE = 31,
        CUSTOM_YESNO = 32,
        DATUM_IDS = 33,
        DEAD_RECKONING = 34,
        DESIG_MOTION_PATTERN = 35,
        DESIG_OBJ_STATUS = 36,
        DESIG_SPOT_TYPE = 37,
        DESIG_SYSTEM_NAME = 38,
        DETONATION_RESULT = 39,
        DISGUISE_STATUS = 40,
        DOMAIN = 41,
        DR_TYPE = 42,
        EMITTER_FUNCTION = 43,
